...
public class StarManager : MonoBehaviour
{
    ...
    public void spawn(int spawnTimes)
    {
        if (maxSpawn > 0)
        {
            ...
            {
                GameObject newStar = Instantiate(Resources.Load<GameObject>("Prefab/HW_Prefab/Star_Prefab"));
    ...
    IEnumerator endGame()
    {
        ...
        {
            int P1score = Controller.GetComponent<PlayerController>().Player[0].score;
            int P2score = Controller.GetComponent<PlayerController>().Player[1].score;
        ...
        Controller.GetComponent<PlayerController>().gameEnd = true;
    }
}
